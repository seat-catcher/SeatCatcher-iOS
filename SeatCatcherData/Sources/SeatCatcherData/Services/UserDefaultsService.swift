...
struct UserDefaultsService: Sendable {
    ...
    static var isOnboardingRequired: Bool {
        get { UserDefaults.standard.bool(forKey: "isOnboardingRequired") }
        set { UserDefaults.standard.set(newValue, forKey: "isOnboardingRequired") }
    }
